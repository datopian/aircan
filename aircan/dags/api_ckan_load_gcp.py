...
# DAG Local import
from aircan.dags.api_ckan_load_multiple_nodes import task_delete_datastore_table, task_create_datastore_table
...
def task_convert_csv_to_json(csv_input, json_output, **kwargs):
    ...
    convert_from_url(csv_input, json_output, Variable.get('CKAN_SYSADMIN_API_KEY'))
